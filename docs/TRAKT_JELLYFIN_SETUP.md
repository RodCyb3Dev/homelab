# Trakt Integration with Jellyfin Setup Guide

This guide explains how to integrate your existing Trakt account with Jellyfin for watch history synchronization, ratings, and collection management.
